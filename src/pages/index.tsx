...
import { COLOR, Cube, FLOAT_SIZE, INT_SIZE, Rect, Scene, Transform, VERTEX_STRIDE } from "~/util/gl/geometry"
...
function init(canvas: HTMLCanvasElement, sizer: HTMLDivElement, theme: Theme) {
...
export default function Home(){
	...
	React.useEffect(() => {
		...
		return init(canvasRef.current!, boxRef.current!, theme);
	})
